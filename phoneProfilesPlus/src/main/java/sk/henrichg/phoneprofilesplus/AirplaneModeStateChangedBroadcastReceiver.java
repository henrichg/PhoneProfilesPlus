        ...
        if (EventStatic.getGlobalEventsRunning(context)) {
            ...
            if (action != null) {
                if (action.equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)) {
                    ...
                    __handler.post(() -> {
//                            PPApplicationStatic.logE("[IN_THREAD_HANDLER] PPApplication.startHandlerThread", "START run - from=AirplaneModeStateChangedBroadcastReceiver.onReceive");
...
//                                PPApplicationStatic.logE("[EVENTS_HANDLER_CALL] AirplaneModeStateChangedBroadcastReceiver.onReceive", "sensorType=SENSOR_TYPE_RADIO_SWITCH");
