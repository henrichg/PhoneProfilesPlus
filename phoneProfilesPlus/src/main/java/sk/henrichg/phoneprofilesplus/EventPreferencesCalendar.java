...
class EventPreferencesCalendar extends EventPreferences {
    ...
    private void removeAlarm(/*boolean startEvent, */Context context)
    {
        ...
        PPApplication.cancelWork(ElapsedAlarmsWorker.ELAPSED_ALARMS_CALENDAR_SENSOR_TAG_WORK+"_" + (int) _event._id);
    }
    ...
    private void setAlarm(@SuppressWarnings("unused") boolean startEvent, long alarmTime, Context context)
    {
        ...
        /*if (applicationUseAlarmClock) {
            ...
            try {
                ...
                //workManager.enqueueUniqueWork("elapsedAlarmsCalendarSensorWork_"+(int)_event._id, ExistingWorkPolicy.KEEP, worker);
