...
//        PPApplicationStatic.logE("[IN_BROADCAST_ALARM] NFCEventEndBroadcastReceiver.onReceive", "xxx");
    ...
    private void doWork(/*boolean useHandler,*/ Context context) {
        ...
        if (EventStatic.getGlobalEventsRunning(context)) {
            ...
            __handler.post(() -> {
//                    PPApplicationStatic.logE("[IN_THREAD_HANDLER] PPApplication.startHandlerThread", "START run - from=NFCEventEndBroadcastReceiver.doWork");
...
//                        PPApplicationStatic.logE("[EVENTS_HANDLER_CALL] NFCEventEndBroadcastReceiver.doWork", "sensorType=SENSOR_TYPE_NFC_EVENT_END");
