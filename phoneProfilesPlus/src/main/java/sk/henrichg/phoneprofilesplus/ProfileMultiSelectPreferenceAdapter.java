...
class ProfileMultiSelectPreferenceAdapter extends BaseAdapter {
    ...
    private final ProfileMultiSelectPreferenceFragment preferenceFragment;
    private final Context context;

    //private final LayoutInflater inflater;

    ProfileMultiSelectPreferenceAdapter(ProfileMultiSelectPreferenceFragment preferenceFragment, Context c, List<Profile> profileList)
    {
        context = c;
