...
class EditorProfileListItemShowInActivatorMenuDialogAdapter extends BaseAdapter
{
    final EditorProfileListItemShowInActivatorMenuDialog dialog;

    final CharSequence[] items;
    private final LayoutInflater inflater;

    EditorProfileListItemShowInActivatorMenuDialogAdapter(int itemsRes, EditorProfileListItemShowInActivatorMenuDialog dialog)
    {
        this.dialog = dialog;
