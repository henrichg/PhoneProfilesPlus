...
//                    Log.e("GrantPermissionActivity.recheckPermissions", "grantBackgroundLocation="+grantBackgroundLocation);
    ...
    private void finishGrant() {
        ...
        if (Permissions.checkPhone(getApplicationContext())) {
            // fill PPApplication.simCardsMutext
            ...
            __handler.post(() -> {
//          PPApplication.logE("[IN_THREAD_HANDLER] PPApplication.startHandlerThread", "START run - from=GrantPermissionActivity.finishGrant");
                ...
                try {
                    if (powerManager != null) {
                        wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, PPApplication.PACKAGE_NAME + ":GrantPermissionActivity_finishGrant");
...
//                        PPApplication.logE("GrantPermissionActivity.finishGrant", "PPApplication.simCardsMutext.sim0Exists="+PPApplication.simCardsMutext.sim0Exists);
//                        PPApplication.logE("GrantPermissionActivity.finishGrant", "PPApplication.simCardsMutext.sim1Exists="+PPApplication.simCardsMutext.sim1Exists);
//                        PPApplication.logE("GrantPermissionActivity.finishGrant", "PPApplication.simCardsMutext.sim2Exists="+PPApplication.simCardsMutext.sim2Exists);
//                        PPApplication.logE("GrantPermissionActivity.finishGrant", "PPApplication.simCardsMutext.simCardsDetected="+PPApplication.simCardsMutext.simCardsDetected);
                    }
                } catch (Exception e) {
