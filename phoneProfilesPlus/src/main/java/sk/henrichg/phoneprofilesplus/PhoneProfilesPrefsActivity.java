...
//            PPApplication.logE("PhoneProfilesPrefsFragment.updateSharedPreferences", "value="+fromPreference.getInt(ApplicationPreferences.PREF_NOTIFICATION_BACKGROUND_CUSTOM_COLOR, 0xFFFFFF));
