...
//--------------------------------------------------------------------------------------------------
    ...
    static public class PhoneProfilesPrefsNotifications extends PhoneProfilesPrefsFragment {
        ...
        void updateSharedPreferences(SharedPreferences.Editor editor, SharedPreferences fromPreference) {
            ...
            editor.putString(ApplicationPreferences.PREF_NOTIFICATION_PREF_INDICATOR_LIGHTNESS, fromPreference.getString(ApplicationPreferences.PREF_NOTIFICATION_PREF_INDICATOR_LIGHTNESS, "50"));
    ...
    static public class PhoneProfilesPrefsWidgetList extends PhoneProfilesPrefsFragment {
        ...
        void updateSharedPreferences(SharedPreferences.Editor editor, SharedPreferences fromPreference) {
            ...
            editor.putBoolean(ApplicationPreferences.PREF_APPLICATION_WIDGET_CHANGE_COLOR_BY_NIGHT_MODE, fromPreference.getBoolean(ApplicationPreferences.PREF_APPLICATION_WIDGET_CHANGE_COLOR_BY_NIGHT_MODE, PPApplication.isPixelLauncherDefault(getContext())));
        }
    }
