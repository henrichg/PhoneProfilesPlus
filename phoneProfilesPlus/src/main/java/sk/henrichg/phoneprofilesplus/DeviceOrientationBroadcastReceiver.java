...
public class DeviceOrientationBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        LocalBroadcastManager.getInstance(appContext).unregisterReceiver(PPApplication.deviceOrientationBroadcastReceiver);
