...
public class DonationGPlayActivity extends AppCompatActivity implements BillingProvider {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gplay_donation);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Fragment fragment = fragmentManager.findFragmentByTag("donationGPlayFragment");
        if (fragment != null) {
