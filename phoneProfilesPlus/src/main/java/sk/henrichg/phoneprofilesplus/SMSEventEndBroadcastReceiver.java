...
//        PPApplicationStatic.logE("[IN_BROADCAST_ALARM] SMSEventEndBroadcastReceiver.onReceive", "xxx");
    ...
    private void doWork(/*boolean useHandler,*/ Context context) {
        ...
        if (EventStatic.getGlobalEventsRunning(context)) {
            ...
            __handler.post(() -> {
//                    PPApplicationStatic.logE("[IN_THREAD_HANDLER] PPApplication.startHandlerThread", "START run - from=SMSEventEndBroadcastReceiver.doWork");
...
//                        PPApplicationStatic.logE("[EVENTS_HANDLER_CALL] SMSEventEndBroadcastReceiver.doWork", "sensorType=SENSOR_TYPE_SMS_EVENT_END");
