...
class EditorProfileListItemMenuDialogAdapter extends BaseAdapter
{
    final EditorProfileListItemMenuDialog dialog;

    final CharSequence[] items;
    private final LayoutInflater inflater;

    EditorProfileListItemMenuDialogAdapter(int itemsRes, EditorProfileListItemMenuDialog dialog)
    {
        this.dialog = dialog;
