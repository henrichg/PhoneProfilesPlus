...
class EditorEventListItemIgnoreManualActivationMenuDialogAdapter extends BaseAdapter
{
    final EditorEventListItemIgnoreManualActivationMenuDialog dialog;

    final CharSequence[] items;
    private final LayoutInflater inflater;

    EditorEventListItemIgnoreManualActivationMenuDialogAdapter(int itemsRes, EditorEventListItemIgnoreManualActivationMenuDialog dialog)
    {
        this.dialog = dialog;
