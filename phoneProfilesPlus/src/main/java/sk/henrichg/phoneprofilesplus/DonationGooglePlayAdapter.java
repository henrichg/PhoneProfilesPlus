    ...
    */
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            vi = inflater.inflate(R.layout.donation_google_android_market_grid_item, parent, false);
            holder.price = vi.findViewById(R.id.donation_google_android_market_grid_item_price);
            vi.setTag(holder);
        }
        else
        {
