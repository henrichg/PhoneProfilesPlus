...
public class PhoneProfilesPrefsWidgetPanel extends PhoneProfilesPrefsFragment {
    ...
    void updateSharedPreferences(SharedPreferences.Editor editor, SharedPreferences fromPreference) {
        ...
        editor.putBoolean(ApplicationPreferences.PREF_APPLICATION_WIDGET_PANEL_ICON_LIGHTNESS_CHANGE_BY_NIGHT_MODE, fromPreference.getBoolean(ApplicationPreferences.PREF_APPLICATION_WIDGET_PANEL_ICON_LIGHTNESS_CHANGE_BY_NIGHT_MODE, ApplicationPreferences.PREF_APPLICATION_WIDGET_PANEL_ICON_LIGHTNESS_CHANGE_BY_NIGHT_MODE_DEFAULT_VALUE));
    }
