...
public final class PPPVoiceServiceBroadcastReceiver extends BroadcastReceiver {
    ...
    /* renamed from: a */
    final /* synthetic */ PPPVoiceService f15819a;

    PPPVoiceServiceBroadcastReceiver(PPPVoiceService macroDroidVoiceService) {
        this.f15819a = macroDroidVoiceService;
    }

    public void onReceive(Context context, Intent intent) {
        C0330j.m960e(intent, "intent");
        if (C1663s.m8938u(intent.getAction(), "com.arlosoft.macrodropid.action.ASSISTANT", false, 2, (Object) null)) {
            this.f15819a.showSession(intent.getExtras(), 0);
        }
    }
}
