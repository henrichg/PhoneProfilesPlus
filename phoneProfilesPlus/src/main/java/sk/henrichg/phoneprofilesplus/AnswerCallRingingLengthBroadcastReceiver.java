...
//        PPApplicationStatic.logE("[IN_BROADCAST] AnswerCallRingingLengthBroadcastReceiver.onReceive", "xxx");
//        PPApplicationStatic.logE("[IN_BROADCAST_ALARM] AnswerCallRingingLengthBroadcastReceiver.onReceive", "xxx");
        ...
        Runnable runnable = () -> {
            ...
            try {
                if (powerManager != null) {
                    wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, WakelockTags.WAKELOCK_TAG_AnswerCallRingingLengthBroadcastReceiver_onReceive);
