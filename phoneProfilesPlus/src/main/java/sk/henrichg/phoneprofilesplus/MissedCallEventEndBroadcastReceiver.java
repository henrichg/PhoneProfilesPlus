...
//        PPApplicationStatic.logE("[IN_BROADCAST_ALARM] MissedCallEventEndBroadcastReceiver.onReceive", "xxx");
    ...
    private void doWork(/*boolean useHandler,*/ Context context) {
        ...
        if (EventStatic.getGlobalEventsRunning(context)) {
            ...
            __handler.post(() -> {
//                    PPApplicationStatic.logE("[IN_THREAD_HANDLER] PPApplication.startHandlerThread", "START run - from=MissedCallEventEndBroadcastReceiver.doWork");
...
//                        PPApplicationStatic.logE("[EVENTS_HANDLER_CALL] MissedCallEventEndBroadcastReceiver.doWork", "sensorType=SENSOR_TYPE_PHONE_CALL_EVENT_END");
