...
//        Log.e("[IN_BROADCAST] ScreenOnOffBroadcastReceiver.onReceive", "isScreenOn="+PPApplication.isScreenOn);
...
//                Log.e("[IN_BROADCAST] ScreenOnOffBroadcastReceiver.onReceive", "action="+action);
...
//            PPApplicationStatic.logE("[IN_EXECUTOR] PPApplication.startHandlerThread", "END run - from=ScreenOnOffBroadcastReceiver.onReceive");
    ...
    private void doScreenOnOff(String action, Context appContext) {
        ...
        Runnable runnable = () -> {
//            PPApplicationStatic.logE("[IN_EXECUTOR] PPApplication.startHandlerThread", "START run - from=ScreenOnOffBroadcastReceiver.doScreenOnOff");
...
//                    Log.e("[IN_BROADCAST] ScreenOnOffBroadcastReceiver.doScreenOnOff", "action="+action);
...
//                          PPApplicationStatic.logE("ScreenOnOffBroadcastReceiver.doScreenOnOff", "screen==ON, call Detector");
                            BluetoothConnectedDevicesDetector.getConnectedDevices(appContext, false);
...
//                                PPApplicationStatic.logE("[TEST BATTERY] ScreenOnOffBroadcastReceiver.doScreenOnOff", "******** ### ******* (1)");
                                restart = true;
                            }
...
//                              PPApplicationStatic.logE("[RESTART_WIFI_SCANNER] ScreenOnOffBroadcastReceiver.doScreenOnOff", "ACTION_SCREEN_ON");
                                PPApplicationStatic.restartAllScanners(appContext, false);
                            }

//                          PPApplicationStatic.logE("[PPP_NOTIFICATION] ScreenOnOffBroadcastReceiver.doScreenOnOff", "call of PPAppNotification.drawNotification");
...
//                                PPApplicationStatic.logE("[TEST BATTERY] ScreenOnOffBroadcastReceiver.doScreenOnOff", "******** ### ******* (2)");
                                restart = true;
                            }
                            else if (ApplicationPreferences.applicationEventOrientationEnableScanning &&
...
//                              PPApplicationStatic.logE("[RESTART_WIFI_SCANNER] ScreenOnOffBroadcastReceiver.doScreenOnOff", "ACTION_SCREEN_OFF");
                                PPApplicationStatic.restartAllScanners(appContext, false);
                            }
...
//                            Log.e("@@@ ScreenOnOffBroadcastReceiver.doScreenOnOff", Log.getStackTraceString(e));
                        }
                    }
                }
                //}

//            PPApplicationStatic.logE("[IN_EXECUTOR] PPApplication.startHandlerThread", "END run - from=ScreenOnOffBroadcastReceiver.doScreenOnOff");
