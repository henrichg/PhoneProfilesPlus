...
//                                PPApplication.logE("@@@ ScreenOnOffBroadcastReceiver.onReceive", "inKeyguardRestrictedInputMode=" + inKeyguardRestrictedInputMode);

                                if (secureKeyguard && (!inKeyguardRestrictedInputMode)) {
