...
public class EditorEventListItemIgnoreManualActivationMenuDialog extends DialogFragment
{
    ...
    public EditorEventListItemIgnoreManualActivationMenuDialog() {
    }

    public EditorEventListItemIgnoreManualActivationMenuDialog(EditorActivity _activity) {
        ...
        if (activity != null) {
            ...
            if (event_id != 0) {
                ...
                if (fragment != null) {
                    ...
                    int itemsRes = R.array.eventListItemIgnoreManualActivationArray;
                    int value;
                            ...
                            (dialog1, which) -> {
                                switch (which) {
                                    case 0:
                                        ...
                                        DatabaseHandler.getInstance(fragment.activityDataWrapper.context).updateEventForceRun(event);
                                        EventsPrefsActivity.saveUpdateOfPreferences(event, fragment.activityDataWrapper, event.getStatus());
                    ...
                    String subtitle = getString(R.string.event_preferences_ForceRun);
                    ...
                    */
                    ...
                    if (listView != null) {
                        EditorEventListItemIgnoreManualActivationMenuDialogAdapter listAdapter = new EditorEventListItemIgnoreManualActivationMenuDialogAdapter(itemsRes, this);
