...
public class AboutApplicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        str2 = str1 + "\n" + PPApplication.PRIVACY_POLICY_URL + StringConstants.CHAR_HARD_SPACE + StringConstants.STR_DOUBLE_ARROW;
        sbt = new SpannableString(str2);
        sbt.setSpan(new StyleSpan(android.graphics.Typeface.BOLD), 0, str2.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        /*ClickableSpan*/ clickableSpan = new ClickableSpan() {
            @Override
        ...
        str2 = str1 + "\n" + PPApplication.GITHUB_PPP_RELEASES_URL + StringConstants.CHAR_HARD_SPACE + StringConstants.STR_DOUBLE_ARROW;
        sbt = new SpannableString(str2);
        sbt.setSpan(new StyleSpan(android.graphics.Typeface.BOLD), 0, str1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        str2 = str1 + "\n" + PPApplication.GITHUB_PPP_URL + StringConstants.CHAR_HARD_SPACE + StringConstants.STR_DOUBLE_ARROW;
        sbt = new SpannableString(str2);
        sbt.setSpan(new StyleSpan(android.graphics.Typeface.BOLD), 0, str1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        clickableSpan = new ClickableSpan() {
            @Override
        ...
        str2 = str1 + "\n" + PPApplication.GITHUB_PPPE_URL + StringConstants.CHAR_HARD_SPACE + StringConstants.STR_DOUBLE_ARROW;
        sbt = new SpannableString(str2);
        sbt.setSpan(new StyleSpan(android.graphics.Typeface.BOLD), 0, str1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        clickableSpan = new ClickableSpan() {
            @Override
        ...
        str2 = str1 + "\n" + PPApplication.GITHUB_PPPPS_URL + StringConstants.CHAR_HARD_SPACE + StringConstants.STR_DOUBLE_ARROW;
        sbt = new SpannableString(str2);
        sbt.setSpan(new StyleSpan(android.graphics.Typeface.BOLD), 0, str1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        clickableSpan = new ClickableSpan() {
            @Override
        ...
        str2 = str1 + "\n" + PPApplication.XDA_DEVELOPERS_PPP_URL + StringConstants.CHAR_HARD_SPACE + StringConstants.STR_DOUBLE_ARROW;
        sbt = new SpannableString(str2);
        sbt.setSpan(new StyleSpan(android.graphics.Typeface.BOLD), 0, str1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        clickableSpan = new ClickableSpan() {
            @Override
...
*/
    ...
    static void emailMe(final TextView textView, final String text, final String linkText, final String subjectText,
        ...
        String str2 = strNoLink + "\nhenrich.gron@gmail.com" + StringConstants.CHAR_HARD_SPACE + StringConstants.STR_DOUBLE_ARROW;
        Spannable sbt = new SpannableString(str2);
