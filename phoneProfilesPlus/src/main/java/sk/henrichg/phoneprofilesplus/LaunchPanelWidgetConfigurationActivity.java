...
public class LaunchPanelWidgetConfigurationActivity extends AppCompatActivity {
    ...
    protected void onStart()
    {
        ...
        try {
            ...
            intent.putExtra(PhoneProfilesPrefsActivity.EXTRA_SCROLL_TO, PhoneProfilesPrefsFragment.PREF_WIDGET_PANEL_CATEGORY_ROOT);
