...
public class PhoneProfilesPrefsNotificationScanning  extends PhoneProfilesPrefsFragment {
    ...
    void updateSharedPreferences(SharedPreferences.Editor editor, SharedPreferences fromPreference) {
        ...
        editor.putString(ApplicationPreferences.PREF_APPLICATION_EVENT_NOTIFICATION_SCAN_INTERVAL, fromPreference.getString(ApplicationPreferences.PREF_APPLICATION_EVENT_NOTIFICATION_SCAN_INTERVAL, ApplicationPreferences.PREF_APPLICATION_EVENT_NOTIFICATION_SCAN_INTERVAL_DEFAULT_VALUE));
