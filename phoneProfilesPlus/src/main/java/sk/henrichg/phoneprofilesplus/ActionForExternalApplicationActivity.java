...
//                PPApplicationStatic.logE("[START_PP_SERVICE] ActionForExternalApplicationActivity.onStart", "xxx");
            ...
            switch (action) {
                ...
                case ACTION_ENABLE_RUN_FOR_EVENT:
                    ...
                    if (event_id != 0) {
                        Event _event = dataWrapper.getEventById(event_id);
                        if (_event != null) {
...
//                                        PPApplicationStatic.logE("[IN_EXECUTOR] PPApplication.startHandlerThread", "START run - from=ActionForExternalApplicationActivity.onStart.1");
                                    ...
                                    if (/*(appContext != null) &&*/ (_dataWrapper != null) && (event != null)) {
    ...
    */
    ...
    private void showNotification(String title, String text) {
        ...
        try {
            ...
            PPApplicationStatic.logException("ActionForExternalApplicationActivity.showNotification", Log.getStackTraceString(en), false);
        } catch (Exception e) {
