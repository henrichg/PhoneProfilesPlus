                                        ...
                                        //implements Application.ActivityLifecycleCallbacks
{
    ...
    static final int VERSION_CODE_EXTENDER_LATEST = 865; //870; //865;      // must be <= as in Extender dependencies.gradle
    static final String VERSION_NAME_EXTENDER_LATEST = "8.1.1"; //"8.1.2"; //"8.1.1"; // must be <= as in Extender dependencies.gradle

    static final int VERSION_CODE_PPPPS_LATEST = 45; //50; //45;          // must be <= as in PPPPS dependencies.gradle
    static final String VERSION_NAME_PPPPS_LATEST = "1.0.4"; //"1.0.5"; //"1.0.4";  // must be <= as in PPPPS dependencies.gradle
