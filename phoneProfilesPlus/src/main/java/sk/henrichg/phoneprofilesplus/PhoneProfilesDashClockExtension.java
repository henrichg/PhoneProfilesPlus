...
public class PhoneProfilesDashClockExtension extends DashClockExtension {
    ...
    protected void onUpdateData(int reason) {
        ...
        if (profile != null)
        {
            ...
            profileName = DataWrapper.getProfileNameWithManualIndicator(profile, true, false, false, dataWrapper);
        }
        else
        {
        ...
        if (profile != null)
        {
            ...
            if (profile._screenNightMode != 0) {
                if (Profile.isProfilePreferenceAllowed(Profile.PREF_PROFILE_SCREEN_NIGHT_MODE, this) == PreferenceAllowed.PREFERENCE_ALLOWED) {
            ...
            */
            ...
            if (profile._applicationDisableWifiScanning != 0) {
                if (Profile.isProfilePreferenceAllowed(Profile.PREF_PROFILE_APPLICATION_DISABLE_WIFI_SCANNING, this).allowed == PreferenceAllowed.PREFERENCE_ALLOWED) {
            ...
            if (profile._applicationDisableBluetoothScanning != 0) {
                if (Profile.isProfilePreferenceAllowed(Profile.PREF_PROFILE_APPLICATION_DISABLE_BLUETOOTH_SCANNING, this).allowed == PreferenceAllowed.PREFERENCE_ALLOWED) {
            ...
            if (profile._applicationDisableLocationScanning != 0) {
                if (Profile.isProfilePreferenceAllowed(Profile.PREF_PROFILE_APPLICATION_DISABLE_LOCATION_SCANNING, this).allowed == PreferenceAllowed.PREFERENCE_ALLOWED) {
            ...
            if (profile._applicationDisableMobileCellScanning != 0) {
                if (Profile.isProfilePreferenceAllowed(Profile.PREF_PROFILE_APPLICATION_DISABLE_MOBILE_CELL_SCANNING, this).allowed == PreferenceAllowed.PREFERENCE_ALLOWED) {
            ...
            if (profile._applicationDisableOrientationScanning != 0) {
                if (Profile.isProfilePreferenceAllowed(Profile.PREF_PROFILE_APPLICATION_DISABLE_ORIENTATION_SCANNING, this).allowed == PreferenceAllowed.PREFERENCE_ALLOWED) {
