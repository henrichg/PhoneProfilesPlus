    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (smsMmsReceived)
        {
            ...
            if (Event.getGlobalEventsRunning(context))
            {
                ...
                PPApplication.startHandlerThread("SMSBroadcastReceiver.onReceive");
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (powerManager != null) {
                            wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, PPApplication.PACKAGE_NAME+":SMSBroadcastReceiver.onReceive");
