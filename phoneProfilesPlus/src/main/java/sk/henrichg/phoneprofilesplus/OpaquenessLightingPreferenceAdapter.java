...
class OpaquenessLightingPreferenceAdapter extends BaseAdapter {

    private final String value;
    private final OpaquenessLightingPreferenceFragment preferenceFragment;

    private final Context context;

    //private final LayoutInflater inflater;

    OpaquenessLightingPreferenceAdapter(OpaquenessLightingPreferenceFragment preferenceFragment, Context c, String value)
    {
        context = c;
