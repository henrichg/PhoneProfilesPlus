...
public final class PPPVoiceService extends VoiceInteractionService {
    ...
    /* renamed from: a */
    public static final C7496a f15817a = new C7496a((C0326f) null);

    /* renamed from: c */
    private final BroadcastReceiver f15818c = new PPPVoiceServiceBroadcastReceiver(this);
    ...
    public static final class C7496a {
        ...
        public /* synthetic */ C7496a(C0326f fVar) {
            this();
        }
    }
    ...
    public void onReady() {
        super.onReady();
        registerReceiver(this.f15818c, new IntentFilter("com.arlosoft.macrodropid.action.ASSISTANT"));
    }

    public void onShutdown() {
        try {
            unregisterReceiver(this.f15818c);
